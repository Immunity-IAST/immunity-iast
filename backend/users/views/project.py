...
class ProjectAPIView(viewsets.ViewSet):
    ...
    def post(self, request):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                command = Command(model=Project, data=data, foreign_keys={"user": self.request.user.id})
    ...
    def put(self, request, pk):
        ...
        try:
            ...
            if serializer.is_valid():
                data = serializer.validated_data
                command = Command(model=Project, entity_id=pk, data=data, foreign_keys={"user": self.request.user.id})
